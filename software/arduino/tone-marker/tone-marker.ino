...
const float FILTER_FREQ_LP = 12000.0;
...
void setup() {
  ...
  filterLeft.setLowpass(0, FILTER_FREQ_LP, 0.54);
  filterLeft.setLowpass(1, FILTER_FREQ_LP, 1.3);
  filterLeft.setLowpass(2, FILTER_FREQ_LP, 0.54);
  filterLeft.setLowpass(3, FILTER_FREQ_LP, 1.3);

  filterRight.setLowpass(0, FILTER_FREQ_LP, 0.54);
  filterRight.setLowpass(1, FILTER_FREQ_LP, 1.3);
  filterRight.setLowpass(2, FILTER_FREQ_LP, 0.54);
  filterRight.setLowpass(3, FILTER_FREQ_LP, 1.3);
